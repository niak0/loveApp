...
class HomeVC: UIViewController {
    ...
    let dataArray = [
        ...
        UserModel(userName: "Merve", userAge: 20, userLocation: "31", city: "Balıkesir", userImages: [UIImage(named: "6")!,UIImage(named: "4")!,UIImage(named: "5")!,UIImage(named: "3")!], verified: "Not verified", userBasicAbout: UserBasicAboutModel(biography: "Selam ben balıkesirden merve beni arayın", lookingFor: "Manita", work: "House Keeper", education: "Hacettepe University", gender: "Female"), userMoreAbout: UserMoreAboutModel(height: "162", exercise: "Somethimes", drinking: "Also", smoking: "Yes", sleepingHabbits: "Night Owl", dietaryPreference: "Vegan", religion: "something", politics: "apolitics", starSign: "Moon")).turnCustomViewModel(),
